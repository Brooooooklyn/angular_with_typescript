...
class Scope12 {
  ...
  private $digestOnce(): boolean {
    ...
    this.$$everyScope(function(scope: Scope12) {
      var oldValue: any;
      var newValue: any;
  ...
  public $new(isolated: boolean, parent: Scope12): Scope12 {
    var child: Scope12;
    parent = parent || this;
    if(isolated) {
      child = new Scope12();
